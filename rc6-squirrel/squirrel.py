...
MOVERATE = 20 #1) pogolema vrednost za pobrzo dvizenje
BOUNCERATE= 25 #1) pogolema vrednost na BOUNCERATE pravi pospor bounce

BOUNCEHEIGHT = 30    # how high the player bounces
STARTSIZE = 25       # how big the player starts off
WINSIZE = 300        # how big the player needs to be to win
#2) promena na vrednosta na 5 sekundi
INVULNTIME = 5       # how long the player is invulnerable after being hit in seconds (2)
GAMEOVERTIME = 4     # how long the "game over" text stays on the screen in seconds
MAXHEALTH = 3        # how much health the player starts with

#2) setiranje na flash intervalot na 1/10 sekundi
FLASH_INTERVAL=0.1
...
#3)
CAMERASLACK_HORIZONTAL = 120
CAMERASLACK_VERTICAL = 60
"""
...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, L_SQUIR_IMG, R_SQUIR_IMG, GRASSIMAGES, CAMERASLACK_HORIZONTAL, CAMERASLACK_VERTICAL
...
def runGame():
    ...
    camerax = CAMERASLACK_HORIZONTAL
    cameray = CAMERASLACK_VERTICAL
    ...
    while True: # main game loop
        ...
        #2) namaluvanje na flash interval
        flashIsOn = round(time.time(), 1) / (2 * FLASH_INTERVAL) % 2 == 1




        #flashIsOn = round(time.time(), 1) * (1 / FLASH_INTERVAL) % 2 == 1
        #flashIsOn = round(time.time(), 1) * 2 % 2 == 1
